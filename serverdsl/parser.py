"""Recursive descent parser for ServerDSL."""
...
class Parser:
    ...
    def parse_app(self) -> AppNode:
        ...
        name = self._consume(TokenType.STRING, "Expected STRING after app")
    ...
    def parse_database(self) -> DatabaseNode:
        ...
        name = self._consume(TokenType.STRING, "Expected STRING after database")
